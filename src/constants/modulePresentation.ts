...
export const MODULE_ICON: Record<string, IonGlyph> = {
  ...
  parts_in_store: 'business-outline',
  parts_price_catalog: 'pricetags-outline',
  parts_conversions: 'swap-horizontal-outline',
  parts_expiration: 'hourglass-outline',
  products_catalog: 'cube-outline',
...
export function colorFamilyForSurfaceId(id: string): ModuleColorFamily {
  const map: Record<string, ModuleColorFamily> = {
    ...
    parts_catalog: 'teal',
    parts_in_store: 'navy',
    parts_price_catalog: 'amber',
    parts_conversions: 'blue',
    parts_expiration: 'coral',
    products_catalog: 'blue',
