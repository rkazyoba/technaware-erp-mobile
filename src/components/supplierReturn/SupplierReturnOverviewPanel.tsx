...
export type SupplierReturnHeaderForm = {
  description: string;
  returnedDate: string;
  supplierId: string;
...
type Props = {
  ...
  lineCount: number;
  editable: boolean;
  form: SupplierReturnHeaderForm;
  storeOptions: SearchableSelectOption[];
  supplierOptions: SearchableSelectOption[];
  loadingStores?: boolean;
  loadingSuppliers?: boolean;
  onChangeForm: (patch: Partial<SupplierReturnHeaderForm>) => void;
...
export function SupplierReturnOverviewPanel({
  detail,
  lineCount,
  editable,
  form,
  ...
  return (
    <View>
      ...
      >
        ...
        >
          ...
          <View style={{ alignItems: 'center', flex: 1 }}>
            ...
            <Text style={{ ...outfit('regular', 11), color: colors.textMuted, marginTop: 2 }}>Returned</Text>
          </View>
        </View>
      </View>
      ...
      <LogisticsLedgerStatusCard
        ...
        ledgerPosted={detail.ledger_posted}
        postedMessage="Posted to ledger (AP reduced, inventory credited)"
      ...
      {editable ? (
        <>
          <FormSection title="Identification">
            <ReadonlyField label="Return no." value={detail.ref} />
          ...
          <FormSection title="Return details">
            <DatePickerField
              ...
              onChange={(returnedDate) => onChangeForm({ returnedDate })}
              marginTop={0}
            />
        ...
        >
          ...
          <MetaRow label="Returned" value={formatDocDate(detail.document_date)} />
